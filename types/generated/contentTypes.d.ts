...
export interface ApiLandingLanding extends Struct.SingleTypeSchema {
  ...
  attributes: {
    Beschreibung: Schema.Attribute.DynamicZone<
      ['landing.starts-text', 'landing.button']
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiLegalNoticeLegalNotice extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Impressum: Schema.Attribute.Component<'impressum.heading-1', false>;
...
export interface ApiPushSubscriptionsPushSubscription
  extends Struct.CollectionTypeSchema {
  collectionName: 'push_subscriptions';
  info: {
    description: 'Stores client push subscription objects';
...
export interface ApiVeranstaltungsortVeranstaltungsort
  extends Struct.CollectionTypeSchema {
  collectionName: 'veranstaltungsorte';
  info: {
    displayName: 'Veranstaltungsort';
    pluralName: 'veranstaltungsorte';
    singularName: 'veranstaltungsort';
  };
  options: {
    draftAndPublish: false;
  };
