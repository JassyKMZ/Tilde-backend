...
module.exports = (plugin) => {
  // Ensure our custom auth handlers are used for plugin routes.
  // This prevents Strapi's default email-confirmation redirect response
  // and keeps SPA-friendly JSON responses.
  ...
  plugin.controllers.auth.emailConfirmation =
    customAuthController.emailConfirmation;
